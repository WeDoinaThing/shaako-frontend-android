...
public class Symptoms {
    private static final List<String> skinAndNails = Arrays.asList(
    ...
    private static final  List<String> stomachAndAppetite = Arrays.asList(
    ...
    private static final  List<String > face = Arrays.asList(
    ...
    private static final  List<String> throatAndChest = Arrays.asList(
    ...
    private static final  List<String> muscleLimbsBonesVessels = Arrays.asList(
    ...
    private static final  List<String> excretion = Arrays.asList(
    ...
    private static final  List<String> riskFactors = Arrays.asList(
    ...
    private static final  List<String> mental = Arrays.asList(
    ...
    private static final  List<String> others = Arrays.asList(
    ...
    public static List<String> getSkinAndNails() {
        return skinAndNails;
    }

    public static List<String> getStomachAndAppetite() {
        return stomachAndAppetite;
    }

    public static List<String> getFace() {
        return face;
    }

    public static List<String> getThroatAndChest() {
        return throatAndChest;
    }

    public static List<String> getMuscleLimbsBonesVessels() {
        return muscleLimbsBonesVessels;
    }

    public static List<String> getExcretion() {
        return excretion;
    }
    ...
    public static List<String> getMental() {
        return mental;
    }

    public static List<String> getOthers() {
        return others;
    }
