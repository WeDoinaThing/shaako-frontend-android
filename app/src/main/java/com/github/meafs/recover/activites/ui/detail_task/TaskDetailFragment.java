...
import com.github.meafs.recover.activites.util.AlertDialogHelper;
...
import com.github.meafs.recover.databinding.TaskDetailBinding;
...
public class TaskDetailFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        taskDetailViewModel.getTask().observe(getViewLifecycleOwner(), this::onChanged);
        taskDetailViewModel.getTaskRunningStatus().observe(getViewLifecycleOwner(), this::taskStatusChanged);
    }
